...
# 通过给定网址下载镜像
curl -o http://"content.example.com:17242/el9/Containerfile
...
[training@servera user]$ systemctl --user enable --now containermagic.service

[training@servera user]$ systemctl --user status containermagic.service
